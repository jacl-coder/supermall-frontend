  ...
  export default {
    ...
    methods: {
      ...
      async fetchConsults() {
        try {
          // TODO: 调用API获取咨询列表
          const response = await this.$http.get(`/api/consults/${this.$route.params.productId}`, {
            params: {
      ...
      async submitConsult() {
        try {
          ...
          // TODO: 调用API提交咨询
          await this.$http.post(`/api/consults/${this.$route.params.productId}`, this.newConsult)
